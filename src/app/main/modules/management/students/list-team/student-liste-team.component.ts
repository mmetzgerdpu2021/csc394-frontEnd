...
import {StarRatingColor} from '../../teacher/component/star-rating/star-rating.component';
import {MatSnackBar, MatTable} from '@angular/material';


@Component({
  selector: 'app-liste-team',
  templateUrl: './student-liste-team.component.html',
  styleUrls: ['./student-liste-team.component.css']
})
export class StudentListeTeamComponent implements OnInit, AfterViewInit{
  ...
  ngAfterViewInit(): void {
    ...
    this.teamService.getAllTeam(false).subscribe(data => {
      this.data = data;
    });
  }
  ...
  rateTeam(element) {
    this.route.navigateByUrl('management/student/team/' + element.teamId);
  }
  AddTeam() {
